...
<body>
  ...
  <div id="wrapper">
    ...
    <footer>
      <div class="container-fluid">
        <p class="copyright">&copy; 2022 OSIS Sekbid IT.</p>
        <p class="copyright">&copy; 2022 <a href="https://www.themeineed.com" target="_blank">Theme I Need</a>. All Rights Reserved.</p>
      </div>
    </footer>
  </div>
  <!-- END WRAPPER -->
